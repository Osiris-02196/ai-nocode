...
import com.oxiris.yuaicodemother.ai.AiCodeGenTypeRoutingService;
import com.oxiris.yuaicodemother.ai.AiCodeGenTypeRoutingServiceFactory;
import com.oxiris.yuaicodemother.constant.AppConstant;
import com.oxiris.yuaicodemother.core.AiCodeGeneratorFacade;
import com.oxiris.yuaicodemother.core.builder.VueProjectBuilder;
import com.oxiris.yuaicodemother.core.handler.StreamHandlerExecutor;
...
import com.oxiris.yuaicodemother.mapper.AppMapper;
import com.oxiris.yuaicodemother.model.entity.User;
import com.oxiris.yuaicodemother.model.enums.ChatHistoryMessageTypeEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        if (!app.getUserId().equals(loginUser.getId())) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "无权访问该应用");
        }
        // 4. 获取应用的代码生成类型
...
//                        chatHistoryService.addChatMessage(appId, aiResponse, ChatHistoryMessageTypeEnum.AI.getValue(), loginUer.getId());
//                    }
//                })
//                .doOnError(error -> {
//                    // 如果AI回复失败，也要记录错误消息
//                    String errorMessage = "AI回复失败: " + error.getMessage();
//                    chatHistoryService.addChatMessage(appId, errorMessage, ChatHistoryMessageTypeEnum.AI.getValue(), loginUer.getId());
//                });
    }
